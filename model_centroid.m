...
title('Histograma das distâcias euclidianas normalizadas aos respectivos centroides. Atributos: LPC')
...
%%
%classificação LPC
LPC_results = classifier_one_centroid(LPC_nonSeizure,LPC_seizure,10,0.995)
...
%%
%classificação PSD
PSD_results = classifier_one_centroid(PSD_nonSeizure,PSD_seizure,10,0.995)
