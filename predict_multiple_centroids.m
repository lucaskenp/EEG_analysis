function [conf_matrix, acuracia, sensibilidade, especificidade, eficiencia, matthews] = predict_multiple_centroids(x,centroids,threshold,truth)
%classifica um vetor de acordo com o limiar de uma distancia a um centroide

dists = calc_distances_clusters(x,centroids);
prediction = zeros(1,length(dists));
